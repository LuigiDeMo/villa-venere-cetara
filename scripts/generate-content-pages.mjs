...
const pages = [
  ...
  },
  {
    ...
    description: 'Indicazioni per Villa Venere: a 84 m dalla fermata bus, 230 m dal terminal traghetti, parcheggio convenzionato e supporto transfer.',
    ...
    sections: [
      ...
      ['Arrivare in auto', 'La villa non dispone di parcheggio privato. È disponibile una convenzione con un parcheggio custodito di Cetara, a circa dieci minuti a piedi oppure un minuto con la navetta locale. In estate traffico e disponibilità dei posti possono cambiare rapidamente.'],
    ...
    bullets: ['Via Lannio 8, Cetara', 'Bus a circa 84 m', 'Traghetti a circa 230 m', 'Spiagge a circa 50 m', 'Parcheggio convenzionato', 'Assistenza transfer'],
  },
  {
    ...
    description: 'Directions to Villa Venere: 84 m from the bus stop, 230 m from the ferry terminal, partner parking and help arranging transfers.',
    ...
    sections: [
      ...
      ['Arriving by car', 'The villa does not have private parking. Guests can use a partner guarded car park in Cetara, roughly ten minutes away on foot or one minute with the local shuttle. Summer traffic and parking availability can change quickly.'],
